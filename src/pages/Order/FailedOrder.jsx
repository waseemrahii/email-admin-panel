...
//               alt=""
//             />
//             <span className="page-header-title"> Failed </span> Orders
//           </h2>
...
const FailedOrder = () => {
  ...
  const [searchQuery, setSearchQuery] = useState("");
  const [filter, setFilter] = useState("failed_to_deliver");
      ...
      <div className="d-flex flex-wrap gap-2 align-items-center mb-3">
        <h2 className="h1 mb-0 flex">
          <img
            ...
            alt=""
          />
          <span className="page-header-title">Failed To Deliver</span> Orders
        </h2>
        <span className="badge badge-soft-dark radius-50 fz-14">
          {orders.length}
        </span>
