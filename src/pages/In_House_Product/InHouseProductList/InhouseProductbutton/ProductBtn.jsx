...
//                                             <h2 className="mb-0">
//                                                 <button type="button" className="btn btn-link d-flex align-items-center gap-2">
//                                                     <FaEdit /> Edit Translation
//                                                 </button>
//                                             </h2>
//                                         </div>
//                                         <div className="card-body">
...
//                                                         <label className="label--alternate text-dark">Language: </label>
