              ...
              <div className="grid-card-wrap">
                <Link to={"/inhouseproductlistproduct"}>
                  <div
                    ...
                    data-link="https://6valley.6amtech.com/admin/products/view/vendor/12"
                  >
                    <div>
                      <img
                        className="avatar avatar-bordered border-gold avatar-60 rounded"
                        src="https://6valley.6amtech.com/storage/app/public/product/thumbnail/2023-06-13-64884ce5791fe.png"
