...
//       try {
//         const response = await fetch(`http://localhost:3000/api/products/vendor/${user._id}/pending`);
...
//       title: 'Are you sure?',
//       text: `Do you want to ${product.status ? 'approved' : 'pending'} this product ?`,
//       icon: 'warning',
...
//       try {
//         const response = await fetch(`http://localhost:3000/api/products/${product._id}/status`, {
//           method: 'PUT',
...
//           Pending Product Approval Product
...
//                       <td>
//                         <span className={`badge bg-${product.status === 'approved'?'green-300 text-white' :'red-100 p-1'} radius-50 fz-14 text-center`}>
//                           {product.status}
//                         </span>
//                       </td>
