...
//       try {
//         const response = await fetch(`http://localhost:3000/api/products/vendor/${user._id}/approved`);
...
//                       <td>
//                         <span className={`badge bg-${product.status === 'approved'?'green-300 text-white' : 'red-300 text-white'} radius-50 fz-14`}>
//                           {product.status}
//                         </span>
//                       </td>
