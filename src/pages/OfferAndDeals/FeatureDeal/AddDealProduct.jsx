...
const AddNewProductComponent = () => {
    ...
    const handleSubmit = (event) => {
        event.preventDefault();
        if (selectedProduct) {
            // Logic to handle form submission with selectedProduct
            console.log(`Product with ID ${selectedProduct} selected`);
        } else {
            console.log('Please select a product');
        }
                                ...
                                <div className="form-group">
                                    <div className="row">
                                        <div className="col-md-12 mt-3">
                                            ...
                                            <div className="dropdown select-product-search w-100">
                                                <input type="text" className="product_id" name="product_id" hidden />
                                                <button className="form-control text-start dropdown-toggle text-capitalize select-product-button" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Select product
                                                </button>
                                                {/* Dropdown menu */}
                                                <div className="dropdown-menu w-100 px-2" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <div className="d-flex flex-column gap-3 max-h-200 overflow-y-auto overflow-x-hidden search-result-box">
                                                        {products.map(product => (
                                                            <div key={product.id} className="select-product-item media gap-3 border-bottom py-2 cursor-pointer action-select-product" onClick={() => handleSelectProduct(product.id)}>
                                                                <img className="avatar avatar-xl border" width="75" src={product.image} alt="" />
                                                                <div className="media-body d-flex flex-column gap-1">
                                                                    <h6 className="product-id" hidden>{product.id}</h6>
                                                                    <h6 className="fz-13 mb-1 text-truncate custom-width product-name">{product.name}</h6>
                        ...
                        <div className="table-responsive">
                            <table className="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td><a href="javascript:" target="_blank" className="font-weight-semibold title-color hover-c1">Family Size Trolley Case Long Lasting and 8 Wheel Waterproof bag</a></td>
                                        <td>500</td>
                                        <td>
                                            <div className="d-flex justify-content-center">
                                                <button title="Delete" className="btn btn-outline-danger btn-sm delete-data-without-form" data-action="https://6valley.6amtech.com/admin/deal/delete-product" data-id="13">
                                                    <AiOutlineDelete />
                                                </button>
                                            </div>
                                        </td>
