      ...
      <div className="card">
        <div className="px-3 py-4">
          <div className="flex flex-col md:flex-row justify-between gap-3 items-center">
            <h5 className="mb-0 text-capitalize d-flex gap-2 font-bold">
              Total Transactions
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center">
              ...
              <button
                type="button"
                className="rounded w-full sm:w-32 px-3 py-2 bg-[#A1CB46] text-white hover:bg-[#7e9f37] text-nowrap btn-block flex items-center gap-2"
              >
            ...
            <tbody>
              {data.map((item, index) => (
                <tr key={item.sl}>
                  ...
                  <td>13 Jun 2023</td>
                  <td>3</td>
                  <td className="text-green-300 ">Soon Stock Out</td>
