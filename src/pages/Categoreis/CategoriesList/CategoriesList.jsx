          ...
          <div className="flex justify-between ">
            <div>
              <h1 className="text-[.9rem] font-bold">
                Category List{" "}
                <span className="bg-gray-300 rounded-lg px-1">13</span>
              </h1>
            </div>
            <div className="flex items-center  gap-4">
              <div className="flex items-center rounded-lg px-4 py-3 border border-blue-300">
                <CiSearch />
                <input
                  type="search"
                  placeholder="Search by Categoreies Name "
                />{" "}
                <span className="bg-[#A1CB46] text-white hover:bg-[#7e9f37] btn px-4 py-1 cursor-pointer">
                  Search
                </span>
              </div>
          ...
          <div className="w-full ">
            <div className="w-full bg-[#F7FAFF] grid grid-cols-2  px-3 py-2 mt-5">
              <div className="flex gap-10 items-center">
                ...
                <h1 className="text-[1rem] font-semibold">Category Image</h1>
